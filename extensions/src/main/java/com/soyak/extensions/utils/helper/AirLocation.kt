//package com.soyak.kotlin.extensions.utils.helper
//
...
//import com.soyak.kotlin.extensions.R
//import com.soyak.extensions.utils.NetworkUtils
//import com.soyak.kotlin.extensions.utils.customscreen.LoadingDialog
...
////        LoadingDialog.Builder().setContext(activity)
////            .setCancelable(false)
...
//                    location.longitude
//                )
//                PrefUtils.createUserLastLocation(Gson().toJson(currentLatLng))
//                hide()
...
//        }
//
//        if (NetworkUtils.isInFlightMode(activityWeakReference.get() as Activity)) {
